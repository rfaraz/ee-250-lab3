...
def get_inbox(recipient: str) -> None:
    ...
    Retrieves the inbox of a specified user by sending a request to the /mail/inbox endpoint.
...
def get_sent(sender: str) -> None:
    """TODO: fill out this docstring (using the send_mail docstring as a guide)
    Retrieves all mail sent by a specified user by sending a request to the /mail/sent endpoint.
    The JSON body of the request contains the following key:
    - sender
...
def get_mail(mail_id: str) -> None:
    """TODO: fill out this docstring (using the send_mail docstring as a guide)
    Retrieves a mail file by sending a request to the /mail/{mail_id} endpoint, where mail_id is 
    a unique id used to identify a specific file.
    The endpoint path of the request contains the following key:
    - mail_id

    Args:
        mail_id(str): A unique ID assigned to each mail file
...
def delete_mail(mail_id: str) -> None:
    """TODO: fill out this docstring (using the send_mail docstring as a guide)
    Deletes a specified mail file by sending a request to /mail/{mail_id}, where mail_id is
    a unique id used to identify a specific file.
    The endpoint path of the request contains the following key:
    - mail_id
